...
//  */
// console.log(
// 	"Licensed under AGPL-3.0: https://github.com/onlinemictest/pitch-detector"
// );

// const WHEEL_NOTES = 24;
// const BUFFER_SIZE = 4096;

// const blobAnimation: (startEl: HTMLElement) => void =
// 	"animate" in Element.prototype
// 		? (el) =>
// 				el.animate([{ transform: "scale(0.33)" }, { transform: "scale(1)" }], {
// 					duration: 125,
// 					easing: "ease",
// 				})
// 		: (el) => toggleClass(el, "blob-animation");

// const shrinkAnimation: (pauseEl: HTMLElement) => void =
// 	"animate" in Element.prototype
// 		? (el) =>
// 				el.animate([{ transform: "scale(3) " }, { transform: "scale(1)" }], {
// 					duration: 125,
// 					easing: "ease",
// 				})
...
// 		throw alert(
// 			`Browser not supported: 'AudioContext.prototype.createAnalyser' is not defined`
// 		);
// 	if (!("createScriptProcessor" in AudioContext.prototype))
// 		throw alert(
// 			`Browser not supported: 'AudioContext.prototype.createScriptProcessor' is not defined`
// 		);
// }

// // @ts-expect-error
// Aubio().then(({ Pitch }) => {
// 	const pitchDetectorEl = document.getElementById(
// 		"pitch-detector"
// 	) as HTMLDivElement | null;
// 	const wheel = document.getElementById(
// 		"pitch-wheel-svg"
// 	) as HTMLImageElement | null;
// 	const freqSpan = document
// 		.getElementById("pitch-freq")
// 		?.querySelector(".freq") as HTMLElement | null;
// 	const noteSpan = document
// 		.getElementById("pitch-freq")
// 		?.querySelector(".note") as HTMLElement | null;
// 	const octaveSpan = document
// 		.getElementById("pitch-freq")
// 		?.querySelector(".octave") as HTMLElement | null;
// 	const startEl = document.getElementById(
// 		"audio-start"
// 	) as HTMLButtonElement | null;
// 	const pauseEl = document.getElementById(
// 		"audio-pause"
// 	) as HTMLButtonElement | null;
// 	const errorEl = document.getElementById(
// 		"circle-text-error"
// 	) as HTMLSpanElement | null;
// 	const freqTextEl = document.getElementById(
// 		"pitch-freq-text"
// 	) as HTMLElement | null;
// 	const privacyNotice = document.querySelector(
// 		".tuners-privacy-box"
// 	) as HTMLElement | null;
// 	if (
// 		!pitchDetectorEl ||
